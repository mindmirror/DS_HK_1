...
Example: [Trakt.TV](http://trakt.tv/show/true-detective)
...
_LAST.FM: GROUP-BASED COLLABORATIVE FILTERING_
...
For a given user (`u_i`), find users that are most similar (e.g. _vector similarity_ or _Pearson correlation_ coefficient )
